		...
		theImages[i].onload = function() {
			if (this.width > size) {
				...
				if (this.parentNode.tagName.toLowerCase() != 'a') {
					...
					zoom.src = 'image/forum.php-mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_lang=1'/*tpa=http://47.100.112.22/demo/manga/static/js/image/zoom.gif*/;
					...
					zoomDiv.onmouseover = function() {
						zoom.src = 'image/forum.php-mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_lang=2'/*tpa=http://47.100.112.22/demo/manga/static/js/image/zoom_h.gif*/;
					};
...
function showFlash(host, flashvar, obj, shareid) {
	var flashAddr = {
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_lang=3' : '../../../../../player.youku.com/player.php/sid/FLASHVAR=/forum.php-mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_lang=4'/*tpa=http://player.youku.com/player.php/sid/FLASHVAR=/v.swf*/,
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&filter=sort&nex_music_tags=all' : '../../../../../player.ku6.com/refer/FLASHVAR/forum.php-mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_lang=4'/*tpa=http://player.ku6.com/refer/FLASHVAR/v.swf*/,
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=1' : 'http://www.youtube.com/v/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=2',
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=3' : 'http://www.5show.com/swf/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=4',
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=5' : 'http://vhead.blog.sina.com.cn/player/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=6',
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=7' : 'http://v.blog.sohu.com/fo/v4/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=2',
		'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=8' : 'http://tv.mofile.com/cn/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=9',
		'music' : 'FLASHVAR',
		'flash' : 'FLASHVAR'
	};
...
function userapp_open() {
	var x = new Ajax();
	x.get('http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=10', function(s){
...
function userapp_close() {
	var x = new Ajax();
	x.get('http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=11', function(s){
		$('my_userapp').innerHTML = s;
...
function showreward() {
	...
	var x = new Ajax();
	x.get('http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=12', function(s){
		if(s) {
			msgwin(s, 2000);
		}
	});
...
function post_add(pid, result) {
	if(result) {
		...
		var x = new Ajax();
		x.get('http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=14', function(s){
			newli.innerHTML = s;
		});
...
function myfriend_post(uid) {
	if($('friend_'+uid)) {
		$('friend_'+uid).innerHTML = '<p>你们现在是好友了，接下来，您还可以：<a href="http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=13" class="xi2" target="_blank">给TA留言</a> ，或者 <a href="http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=15" id="a_poke_'+uid+'" class="xi2" onclick="showWindow(this.id, this.href, \'get\', 0, {\'ctrlid\':this.id,\'pos\':\'13\'});">打个招呼</a></p>';
	}
	showCreditPrompt();
}
...
function searchpostbyusername(keyword, srchuname) {
	window.location.href = 'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=16' + keyword + '&srchuname=' + srchuname + '&searchsubmit=yes';
}

function removeVisitor(event, uid) {
	window.location = 'http://47.100.112.22/demo/manga/static/js/forum.php?mod=forumdisplay&fid=58&filter=sortid&sortid=4&searchsort=1&nex_music_tags=17'+uid+'&do=index&view=admin&additional=removevlog';
