...
function initSearchmenu(searchform, cloudSearchUrl) {
	var defaultUrl = 'http://47.100.112.22/demo/manga/static/js/search.php?searchsubmit=yes';
...
function pluginNotice() {
	if($('plugin_notice')) {
		ajaxget('http://47.100.112.22/demo/manga/static/js/misc.php?mod=patch&action=pluginnotice', 'plugin_notice', '');
	}
}
