...
namespace MoreNote.Logic.Migrations
{
    ...
    [Migration("20200114114246_FirstMigration18")]
    partial class FirstMigration18
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoreNote.Logic.Entity.Archive", b =>
                {
            ...
            modelBuilder.Entity("MoreNote.Logic.Entity.ArchiveMonth", b =>
                {
                    b.Property<long>("ArchiveMonthId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("ArchiveMonthId");

                    b.HasIndex("ArchiveId");

                    b.ToTable("ArchiveMonth");
                });
            ...
            modelBuilder.Entity("MoreNote.Logic.Entity.BlogUrls", b =>
                {
                    b.Property<long>("BlogUrlsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.Property<string>("SingleUrl")
                        .HasColumnType("text");

                    b.Property<string>("TagPostsUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MoreNote.Logic.Entity.File", b =>
                {
            ...
            modelBuilder.Entity("UserAndBlog", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("UserAndBlog");
                });

            modelBuilder.Entity("UserAndBlogUrl", b =>
                {
                    b.Property<long>("UserAndBlogUrlId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("UserAndBlogUrlId");

                    b.ToTable("UserAndBlogUrl");
                });

            modelBuilder.Entity("MoreNote.Logic.Entity.ArchiveMonth", b =>
                {
                    b.HasOne("MoreNote.Logic.Entity.Archive", null)
                        .WithMany("MonthAchives")
