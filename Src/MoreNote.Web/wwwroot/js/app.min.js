...
function formArrDataToJson(t) {
    ...
    for (var o in t) {
        var r = t[o].name
            , i = t[o].value;
        "[]" != r.substring(r.length - 2, r.length) ? e[r] = i : (r = r.substring(0, r.length - 2),
...
function formSerializeDataToJson(t) {
    for (var e = t.split("&"), n = {}, o = {}, r = 0; r < e.length; ++r) {
        var i = e[r].split("=")
            , a = decodeURI(i[0])
            , s = decodeURI(i[1]);
        "[]" != a.substring(a.length - 2, a.length) ? n[a] = s : (a = a.substring(0, a.length - 2),
...
function _ajaxCallback(t, e, n) {
    if (t === !0 || "true" == t || "object" == typeof t) {
        ...
        "function" == typeof n ? n(t) : alert("error!")
}
...
function getVendorPrefix() {
    for (var t = document.body || document.documentElement, e = t.style, n = ["webkit", "khtml", "moz", "ms", "o"], o = 0; o < n.length;) {
        if ("string" == typeof e[n[o] + "Transition"])
            return n[o];
        o++
    }
}
function switchEditor(t) {
    LEA.isM = t,
        t ? ($("#mdEditor").css("z-index", 3).show(),
            $("#leanoteNav").hide()) : ($("#editor").show(),
...
function setEditorContent(t, e, n, o) {
    if (t || (t = ""),
        ...
        MD ? (MD.setContent(t),
            ...
            o && o()) : clearIntervalForSetContent = setTimeout(function () {
...
function _getEditorContent(t) {
    ...
    if (e) {
        ...
        if (n.find(".toggle-raw").remove(),
            window.LeaAce && LeaAce.getAce)
        ...
        if (n.find("pinit").remove(),
            n.find(".thunderpin").remove(),
            n.find(".pin").parent().remove(),
            n = $(n).html())
            for (; ;) {
...
function disableEditor() {
    ...
    t && (t.hide(),
        LEA.editorStatus = !1,
        $("#mceTollbarMark").show().css("z-index", 1e3))
}
...
function saveBookmark() {
    try {
        if (LEA.bookmark = tinymce.activeEditor.selection.getBookmark(),
            ...
            if (n.is("span")) {
                var o = n
                    , r = o.eq(0);
                r.attr("id") == LEA.bookmark.id + "_start" ? (LEA.hasBookmark = !1,
                    r.remove()) : LEA.hasBookmark = !0
            } else if (n.is("p")) {
                var o = n.children();
                if (1 == o.length && "" == $.trim(n.text())) {
                    var r = o.eq(0);
                    r.attr("id") == LEA.bookmark.id + "_start" ? (LEA.hasBookmark = !1,
                        n.remove()) : LEA.hasBookmark = !0
                } else
                    LEA.hasBookmark = !0
            }
        }
...
Note.curNoteId = "",
    ...
    Note.renderNotesAndFirstOneContent = function (t, e) {
        isArray(t) && (Note.renderNotes(t, !1, !1, e),
    ...
    Note.curHasChanged = function (t, e) {
        ...
        o.IsNew && (i.hasChanged = !0,
            i.title = a,
            LEA.topInfo && (i.Src = LEA.topInfo.src)),
            o.Title != a && (i.hasChanged = !0,
                i.Title = a),
            arrayEqual(o.Tags, n) || (i.hasChanged = !0,
                i.Tags = n.join(","));
        var r = !1;
        if ((o.IsNew || t || !Note.readOnly) && (r = !0),
            !i.hasChanged && !r)
            return !1;
        if (!r)
            return i;
        ...
        if (isArray(l) ? (s = l[0],
            ...
            s || (c = ""),
            o.Preview = c) : s = l,
            i.Src && LEA.topInfo && a === LEA.topInfo.title && !i.Tags && (!s || "<p><br></p>" == s) && (!e || !e.ctrls))
            return !1;
        if (o.Content != s) {
            i.hasChanged = !0,
                i.Content = s;
            var d = c || s;
            o.HasSelfDefined && o.IsBlog || (i.Desc = Note.genDesc(d),
    ...
    Note.curChangedSaveIt = function (t, e, o) {
        ...
        if (Note.curNoteId && !Note.isReadOnly) {
            ...
            return n && n.hasChanged ? (log("需要保存..."),
                ...
                ajaxPost("/note/updateNoteOrContent", n, function (t) {
                    a.saveInProcess[n.NoteId] = !1,
                        n.IsNew && (t.IsNew = !1,
                            Note.setNoteCache(t, !1),
                            Pjax.changeNote(t)),
                        e && e(),
                        showMsg(getMsg("saveSuccess"), 1e3)
                }),
                void 0 != n.Tags && "string" == typeof n.Tags && (n.Tags = n.Tags.split(",")),
    ...
    Note.directToNote = function (t) {
        var e = $("#noteItemList")
            ...
            , a = $("[noteId='" + t + "']").position();
        if (!a)
            return void console.error("no position: " + t);
        var n = a.top
            , i = e.scrollTop();
        if (n += i,
            n >= i && o + i >= n)
            ...
            log("定位到特定note, 在可视范围内"),
                LEA.isMobile || Mobile.isMobile() || ($("#noteItemList").scrollTop(r),
    ...
    Note.changeNoteForPjax = function (t, e, o) {
        ...
        if (n) {
            ...
            void 0 == o && (o = !0),
                ...
                o && (i ? $("#myShareNotebooks").hasClass("closed") && $("#myShareNotebooks .folderHeader").trigger("click") : $("#myNotebooks").hasClass("closed") && $("#myNotebooks .folderHeader").trigger("click"),
    ...
    Note.changeNote = function (t, e, o, a) {
        ...
        if (t) {
            ...
            if (s) {
                ...
                c ? (Note.hideReadOnly(),
                    Note.renderNote(s)) : Note.renderNoteReadOnly(s),
                ...
                e && (d = "/share/getShareNoteContent",
                    N.sharedUserId = s.UserId),
                    i.showContentLoading(),
                    null != Note.contentAjax && Note.contentAjax.abort(),
                    Note.contentAjax = ajaxGet(d, N, function (t) {
                        return function (e) {
                            delete e.IsBlog,
                                n(e, t)
                        }
    ...
    Note.renderChangedNote = function (t) {
        if (t) {
            ...
            t.Title && e.find(".item-title").html(trimTitle(t.Title)),
                ...
                t.ImgSrc ? ($thumb = e.find(".item-thumb"),
                    $thumb.length > 0 ? $thumb.find("img").attr("src", t.ImgSrc) : (e.append(tt('<div class="item-thumb" style=""><img src="?"></div>', t.ImgSrc)),
                        e.addClass("item-image")),
                    e.find(".item-desc").removeAttr("style")) : "" == t.ImgSrc && (e.find(".item-thumb").remove(),
                        e.removeClass("item-image"))
        }
    }
    ,
    ...
    Note.showEditorMask = function () {
        $("#editorMask").css("z-index", 10).show(),
            Notebook.curNotebookIsTrashOrAll() ? ($("#editorMaskBtns").hide(),
                $("#editorMaskBtnsEmpty").show()) : ($("#editorMaskBtns").show(),
...
Note.checkSorter = function (t) {
    t || (t = "dateUpdatedDESC");
    var e = $(".sorter-" + t);
    e.is(".checked") || ($sorterStyles.removeClass("checked"),
        e.addClass("checked"))
}
    ,
    ...
    Note._renderNotes = function (t, e, o, a) {
        for (var n = t.length, i = 20 * (a - 1); n > i && 20 * a > i; ++i) {
            ...
            Note.nowIsInShared = !1,
                (o || r.UserId != UserInfo.UserId) && (s = "item-shared",
                    Note.nowIsInShared = !0),
                e || 0 != i || (s += " item-active");
            var c;
    ...
    Note.newNote = function (t, e, o, a) {
        ...
        i = e ? tt(Note.newItemTpl, r, this.newNoteSeq(), o, n.NoteId, n.Title, c, l, "") : tt(Note.newItemTpl, r, this.newNoteSeq(), "", n.NoteId, n.Title, c, l, ""),
            ...
            Notebook.isCurNotebook(t) ? Note.noteItemListO.prepend(i) : (Note.clearAll(),
                Note.noteItemListO.prepend(i),
                e ? Share.changeNotebookForNewNote(t) : Notebook.changeNotebookForNewNote(t)),
    ...
    Note.changeToNext = function (t) {
        ...
        if (!o.length) {
            var a = e.prev();
            if (!a.length)
                return void Note.showEditorMask();
            o = a
        }
    ...
    Note.changeToNextSkipNotes = function (t) {
        ...
        if (!isEmpty(t)) {
            ...
            if (1 == t.length) {
                ...
                if (1 == o.length && o.attr("noteId") != t[0])
                    return
            }
    ...
    Note.deleteNote = function (t, e, o) {
        ...
        if (a = n.inBatch ? n.getBatchNoteIds() : [$(t).attr("noteId")],
            !isEmpty(a)) {
            1 == a.length && $(t).hasClass("item-active") && (Note.stopInterval(),
                n.clearCurNoteId(),
                Note.clearNoteInfo());
            var i;
                ...
                ajaxPost("/note/deleteNote", {
                    ...
                    if (t) {
                        ...
                        for (var e = 0; e < a.length; ++e) {
                            var o = a[e]
                                , r = n.getNote(o);
                            r && (Notebook.minusNotebookNumberNotes(r.NotebookId),
    ...
    Note.isSameSearch = function (t) {
        ...
        return Note.isOver2Seconds = o > 2e3 ? !0 : !1,
            !Note.lastKey || Note.lastKey != t || o > 1e3 ? (Note.lastKey = t,
                Note.lastSearchTime = e,
                !1) : t == Note.lastKey ? !0 : (Note.lastSearchTime = e,
                    Note.lastKey = t,
                    !1)
    }
    ,
    Note.searchNote = function () {
        ...
        return t ? void (Note.isSameSearch(t) || (Note.lastSearch && Note.lastSearch.abort(),
            Note.curChangedSaveIt(),
            Note.clearAll(),
            showLoading(),
            ...
            Note.listIsIn(!1, !0),
            $("#tagSearch").hide(),
            Note.lastSearch = $.post("/note/searchNote", {
                key: t
            }, function (t) {
                hideLoading(),
                    Notebook.hideNoteAndEditorLoading(),
                    t && (Note.lastSearch = null,
                        Note.renderNotes(t),
            ...
            ajaxPost("/note/moveNote", {
                ...
                if (e) {
                    ...
                    for (var i = 0; i < o.length; ++i) {
                        var r = o[i]
                            , s = a.getNote(r);
                        s && (s.NotebookId != n ? (Notebook.incrNotebookNumberNotes(n),
                            s.IsTrash || Notebook.minusNotebookNumberNotes(s.NotebookId)) : s.IsTrash && Notebook.incrNotebookNumberNotes(s.NotebookId),
                    ...
                    c = 1 == o.length ? t : a.$itemList.find(".item-active"),
                        Notebook.curActiveNotebookIsAll() ? (c.find(".note-notebook").html(Notebook.getNotebookTitle(n)),
                            a.changeNote(c.eq(0).attr("noteId"))) : (a.changeToNextSkipNotes(o),
                                c.remove())
                }
            }),
                a.batch.reset()
    ...
    Note.toggleReadOnly = function (t) {
        ...
        a.addClass("read-only").removeClass("all-tool"),
            ...
            o && ($(".info-toolbar").removeClass("invisible"),
                o.IsMarkdown ? ($("#mdInfoToolbar .created-time").html(goNowToDatetime(o.CreatedTime)),
                    $("#mdInfoToolbar .updated-time").html(goNowToDatetime(o.UpdatedTime))) : ($("#infoToolbar .created-time").html(goNowToDatetime(o.CreatedTime)),
                        $("#infoToolbar .updated-time").html(goNowToDatetime(o.UpdatedTime))),
                t && Note.curChangedSaveIt(),
                Note.readOnly = !0,
                LEA.readOnly = !0,
                o.IsMarkdown || $("#editorContent pre").each(function () {
    ...
    LEA.toggleWriteable = Note.toggleWriteable = function (t) {
        ...
        o && (Note.readOnly = !1,
            LEA.readOnly = !1,
            o.IsMarkdown ? MD && (t || MD.focus(),
                MD.onResize()) : ($("#editorContent pre").each(function () {
...
var Attach = {
        ...
        $("#showAttach").click(function () {
            ...
            t.attachListO.on("click", ".delete-attach", function (e) {
                ...
                var o = $(this).closest("li").data("id")
                    , a = this;
                confirm(getMsg("Are you sure to delete it ?")) && ($(a).button("loading"),
    ...
    renderNoteAttachNum: function (t, e) {
        var o = this
            , a = Note.getNote(t);
        a.AttachNum ? (o.attachNumO.html("(" + a.AttachNum + ")").show(),
            o.downloadAllBtnO.show(),
            o.linkAllBtnO.show()) : (o.attachNumO.hide(),
                o.downloadAllBtnO.hide(),
                o.linkAllBtnO.hide()),
    ...
    _renderAttachs: function (t) {
        ...
        l && (l.AttachNum = a,
            e.renderNoteAttachNum(l.NoteId, !1))
    },
    _bookmark: null,
    renderAttachs: function (t) {
        var e = this;
        return e.loadedNoteAttachs[t] ? void e._renderAttachs(e.loadedNoteAttachs[t]) : (e.attachListO.html('<li class="loading"><img src="/images/loading-24.gif"/></li>'),
            void ajaxGet("/attach/getAttachs", {
                noteId: t
            }, function (o) {
                var a = [];
                o.Ok && (a = o.List,
...
Note.inBatch = !1,
    Note.getBatchNoteIds = function () {
        for (var t = [], e = Note.$itemList.find(".item-active"), o = 0; o < e.length; ++o)
        ...
        init: function () {
            ...
            t.$noteItemList.on("click", ".item", function (e) {
                ...
                t.$noteItemList.on("mousedown", ".item", function (e) {
                    t.canBatch() && (t.isContextMenu(e) || (t._startMove || !(e.metaKey || e.ctrlKey || e.shiftKey)) && (t._startNoteO = $(this),
                        t._startMove = !0))
                }),
                t.$noteItemList.on("mousemove", ".item", function (e) {
                    t.canBatch() && t._startMove && (Note.curChangedSaveIt(),
                        t.clearAllSelect(),
                        t.selectTo($(this)),
                        t.finalFix(!0))
                });
            ...
            e.on("mouseup", function () {
                ...
                e.keydown(function (e) {
                    e.target && "BODY" === e.target.nodeName && (e.ctrlKey || e.metaKey) && 65 === e.which && (e.preventDefault(),
                        t.canBatch() && (Note.curChangedSaveIt(),
                            t.selectAll(),
                            t.finalFix()))
                }),
    ...
    $(function () {
        Attach.init(),
            ...
            $("#searchNoteInput").on("keydown", function (t) {
                var e = t.keyCode || t.witch;
                return 13 == e || 108 == e ? (t.preventDefault(),
                    Note.searchNote(),
                    !1) : void 0
            }),
...
function initEditor() {
    $("#moreBtn").click(function () {
        ...
        $("body").on("keydown", function (e) {
            ...
            if (o) {
                if (83 == t)
                    return Note.curChangedSaveIt(!0, null, {
                        ctrls: !0
                    }),
                        e.preventDefault(),
                        !1;
                if (69 == t)
                    return Note.toggleWriteableAndReadOnly(),
                        e.preventDefault(),
                        !1
            }
        })
...
function _initPage(e, t) {
    if (e ? (curNoteId = e.NoteId,
        curNotebookId = e.NotebookId,
        noteContentJson = e) : t && (curNoteId = null),
...
editorMode.prototype.toggleAText = function (e) {
    ...
    setTimeout(function () {
        ...
        e ? (o.attr("href", "#" + t.normalHash),
            i.text(getMsg("normalMode"))) : (o.attr("href", "#" + t.writingHash),
                i.text(getMsg("writingMode")))
    }, 0)
}
    ,
    ...
    editorMode.prototype.normalMode = function () {
        ...
        e += ".css";
        $("#themeLink");
        //-1 != this.$themeLink.attr("href").indexOf("writting-overwrite.css") && this.$themeLink.attr("href", LEA.sPath + "/css/theme/" + e),
        -1 != this.$themeLink.attr("href").indexOf("writting-overwrite.css") && this.$themeLink.attr("href",  "/css/theme/" + e),
    ...
    editorMode.prototype.writtingMode = function () {
        Note.inBatch || (-1 == this.$themeLink.attr("href").indexOf("writting-overwrite.css") && this.$themeLink.attr("href", LEA.sPath + "/css/theme/writting-overwrite.css"),
...
var Resize = {
    ...
    initEvent: function () {
        ...
        $(".noteSplit").bind("mousedown", function (t) {
            ...
            e.body.bind("mousemove", function (t) {
                e.lineMove ? (t.preventDefault(),
                    e.resize3Columns(t)) : e.mdLineMove && (t.preventDefault(),
                        e.resizeMdColumns(t))
            }),
    ...
    resize3Columns: function (e, t) {
        ...
        var i, n;
        o.lineMove && ("notebookSplitter" == o.target ? (i = e.clientX,
            n = o.noteList.width(),
            o.set3ColumnsWidth(i, n)) : (i = o.leftNotebook.width(),
                n = e.clientX - i,
    ...
    setMdColumnWidth: function (e) {
        var t = this
            , o = $("#note").width();
        e > 100 && o - 80 > e && (UserInfo.MdEditorWidth = e,
...
Mobile = {
    ...
    changeNote: function (e) {
        var t = this;
        return LEA.isMobile ? (t.toEditor(!0, e),
            !1) : !0
    },
    ...
    switchPage: function () {
        var e = this;
        return !LEA.isMobile || LEA.isIpad ? !0 : (e.bodyO.hasClass("full-editor") ? e.toNormal(!0) : e.toEditor(!0),
            !1)
    }
};
var random = 1;
LEA.s3 = new Date,
    ...
    $(".folderHeader").click(function () {
        var e = $(this).next()
            , t = $(this).parent();
        e.is(":hidden") ? ($(".folderNote").removeClass("opened").addClass("closed"),
            t.removeClass("closed").addClass("opened"),
            $(this).find(".fa-angle-right").removeClass("fa-angle-right").addClass("fa-angle-down")) : ($(".folderNote").removeClass("opened").addClass("closed"),
...
var Pjax = {
    init: function () {
        ...
        window.addEventListener("popstate", function (t) {
            var o = t.state;
            o && (document.title = o.title || "Untitled",
                log("pop"),
                e.changeNotebookAndNote(o.noteId))
        }, !1),
            history.pushState || $(window).on("hashchange", function () {
    ...
    changeNote: function (e) {
        var t = e.NoteId
            , o = e.Title
            , i = "/note/NoteEditor/" + t;
        if (location.href.indexOf("?online") > 0 && (i += "?online=" + /online=([0-9])/.exec(location.href)[1]),
...
$(function () {
    ...
    LeaAce = {
        ...
        canAce: function () {
            return this._isInit ? this._canAce : ("webkit" != getVendorPrefix() || Mobile.isMobile() ? this._canAce = !1 : this._canAce = !0,
                this._isInit = !0,
                this._canAce)
        },
            ...
            if (o || i.canAndIsAce()) {
                ...
                if (0 != n.length) {
                    ...
                    try {
                        ...
                        (n.attr("style") || !s && -1 != n.html().indexOf("<style>")) && n.html(n.text()),
        ...
        isInPre: function (e) {
            var t = $(e)
                , e = t.get(0);
            return "PRE" == e.nodeName ? !0 : ($pre = t.closest("pre"),
                0 == $pre.length ? !1 : !0)
        },
        isInAce: function (e) {
            if (this.canAce()) {
...
function reRenderTags() {
    ...
    $("#tags").children().each(function () {
        ...
        ("label label-default" == t || "label label-info" == t) && ($(this).removeClass(t).addClass(a[e % 2]),
            e++)
    })
}
Tag.classes = {
    ...
    Tag.renderReadOnlyTags = function (a) {
        function e() {
            return t ? "label label-default" : (t = !0,
                "label label-info")
        }
        $("#noteReadTags").html(""),
    ...
    Tag.appendTag = function (a, e) {
        ...
        var g = l;
        "zh" == LEA.locale && (l = Tag.mapEn2Cn[l] || l,
            g = Tag.mapCn2En[g] || g),
        ...
        $("#tags").children().each(function () {
            if (n) {
                ...
                l + "X" == $(this).text() && ($(this).remove(),
                    s = !0)
        }),
            $("#tags").append(a),
            hideTagList(),
            n || reRenderTags(),
            e && (s || Note.curChangedSaveIt(!0, function () {
    ...
    $(function () {
        ...
        function e() {
            ...
            Note.curChangedSaveIt(),
                ...
                ajaxGet("/note/searchNoteByTags", {
                    ...
                    hideLoading(),
                        a && (Note.renderNotes(a),
                            isEmpty(a) || Note.changeNote(a[0].NoteId))
                })
        }
        $("#addTagTrigger").click(function () {
            ...
            $("#addTagInput").keydown(function (a) {
                13 == a.keyCode && (hideTagList(),
                    $("#addTagInput").val() ? ($(this).trigger("blur"),
                        $("#addTagTrigger").trigger("click")) : $(this).trigger("blur"))
            }),
...
Notebook.curNotebookId = "",
    ...
    Notebook.setCache = function (o) {
        var e = o.NotebookId;
        e && (Notebook.cache[e] || (Notebook.cache[e] = {}),
    ...
    Notebook.getTreeSetting = function (o, e) {
        function t(o, t) {
            ...
            if (a.remove(),
                n.before(a),
                e ? Share.isDefaultNotebookId(t.NotebookId) || n.after($('<span class="fa notebook-setting" title="setting"></span>')) : Notebook.isAllNotebookId(t.NotebookId) || Notebook.isTrashNotebookId(t.NotebookId) || (n.after($('<span class="notebook-number-notes" id="numberNotes_' + t.NotebookId + '">' + (t.NumberNotes || 0) + "</span>")),
                    n.after($('<span class="fa notebook-setting" title="setting"></span>'))),
                t.level > 1) {
        ...
        var s = {
            ...
            callback: {
                ...
                beforeRename: function (o, e, t, N) {
                    if ("" == t)
                        return e.IsNew ? (b.tree.removeNode(e),
                            !0) : !1;
                    if (e.Title == t)
                        return !0;
                    if (e.IsNew) {
                        ...
                        b.doUpdateNotebookTitle(e.NotebookId, t);
                    return !0
                }
            }
        };
    ...
    Notebook.renderNotebooks = function (o) {
        ...
        n.hover(function () {
            ...
            isEmpty(o) || (Notebook.curNotebookId = o[0].NotebookId,
                e.cacheAllNotebooks(o)),
            Notebook.renderNav(),
    ...
    Notebook.getChangedNotebooks = function (o) {
        for (var e = this, t = "", N = o.length, a = 0; N > a; ++a) {
            ...
            isEmpty(n.Subs) || (b += "<ul class='dropdown-menu'>",
    ...
    Notebook.changeNotebookNavForNewNote = function (o, e) {
        ...
        if (Notebook.isAllNotebookId(o) || Notebook.isTrashNotebookId(o)) {
            ...
            $("#curNotebookForNewNote").html(e).attr("notebookId", o)
    }
    ,
    ...
    Notebook.changeNotebookNav = function (o) {
        ...
        var e = Notebook.cache[o];
        e && ($("#curNotebookForListNote").html(e.Title),
    ...
    Notebook.changeNotebook = function (o, e) {
        ...
        if (Notebook.isTrashNotebookId(o))
            ...
            if (a = {},
                ...
                !isEmpty(cacheNotes))
                return void (e ? e(cacheNotes) : Note.renderNotesAndFirstOneContent(cacheNotes, !0))
        } else {
        ...
        t.showNoteAndEditorLoading(),
            ...
            function (o) {
                ajaxGet(N, a, function (N) {
                    return o != t.changeNotebookSeq ? (log("notebook changed too fast!"),
                        void log(N)) : (e ? e(N) : Note.renderNotesAndFirstOneContent(N, !1),
    ...
    Notebook.setNotebook2Blog = function (o) {
        ...
        void 0 != t.IsBlog && (N = !t.IsBlog),
            ...
            ajaxPost("/notebook/setNotebook2Blog", {
                ...
                o && (Note.setAllNoteBlogStatus(e, N),
                    Notebook.setCache({
                        NotebookId: e,
                        IsBlog: N
                    }))
    ...
    Notebook.deleteNotebook = function (o) {
        ...
        t && ajaxGet("/notebook/deleteNotebook", {
            ...
            o.Ok ? (e.tree.removeNode(e.tree.getNodeByTId(t)),
                e.tree2 && e.tree2.removeNode(e.tree2.getNodeByTId(t)),
                delete Notebook.cache[t],
                Notebook.changeNav()) : alert(o.Msg)
        })
    }
    ,
    $(function () {
...
function addShareNoteOrNotebook(e) {
    ...
    if (r) {
        ...
        Share.dialogIsNote || (s = "/share/addShareNotebook",
            i = {
                notebookId: o,
                emails: [r],
                perm: a
...
Share.defaultNotebookId = "share0",
        ...
        if (!isEmpty(e)) {
            ...
            $(".friend-notebooks").hover(function () {
                ...
                $(".friend-header i").click(function () {
                    var e = $(this)
                        , t = $(this).parent().next();
                    t.is(":hidden") ? (t.slideDown("fast"),
                        e.removeClass("fa-angle-right fa-angle-down").addClass("fa-angle-down")) : (t.slideUp("fast"),
                            e.removeClass("fa-angle-right fa-angle-down").addClass("fa-angle-right"))
                });
            var f = {
                width: 180,
                items: [{
    ...
    Share.changeNotebook = function (e, t, o) {
        ...
        0 == a.length ? (Notebook.selectNotebook($(tt('#friendContainer_? a[notebookId="?"]', e, r.defaultNotebookId))),
            t = r.defaultNotebookId) : Notebook.selectNotebook(a),
    ...
    $(function () {
        $("#noteItemList").on("click", ".item-shared .item-setting", function (e) {
            ...
            $("#leanoteDialogRemote").on("click", ".change-perm", function () {
                ...
                Share.dialogIsNote ? (s = "/share/updateShareNotePerm",
                    i.noteId = o) : i.notebookId = o,
            ...
            $("#leanoteDialogRemote").on("click", ".delete-share", function () {
                ...
                Share.dialogIsNote ? (r = "/share/deleteShareNote",
                    a.noteId = t) : a.notebookId = t,
